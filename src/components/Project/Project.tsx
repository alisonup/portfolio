        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Telegram Bot</h3>
              <p>
                The @DropmailBot is a reliable bot on Telegram that is used to
                provide disposable email addresses from the dropmail.me service.
                Its main purpose is to protect your privacy and keep your
                primary email clutter-free. The bot is a practical tool mainly
                for private users.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                We are the world’s most accomplished blockchain experts spanning
                engineering, cryptography, research, and design. Working with
                us, you can access a range of services that will address your
                specific blockchain needs. Together, we can harness the unique
                technologies that have made Algorand an industry leader, and
                help you to launch your own permissioned chain or develop other
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://watch.motortrend.com/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
